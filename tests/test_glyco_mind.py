...
import pytest
from glyco_mind.models import FrontierPayload, ExecutionStatus
from glyco_mind.engine import FrontierDomainEngine
from glyco_mind.agents import DomonCostelloFragmentAgent, GlycoCTEncoderAgent, AfucosylationFractionAgent, GlycoMindCoordinator
from glyco_mind.cli import main


def test_sub_agents():
    a1 = DomonCostelloFragmentAgent()
...
def test_coordinator():
    ...
    assert "SNFG / GlycoCT Structural Representation" in ans or "specifications" in ans
