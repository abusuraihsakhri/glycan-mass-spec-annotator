"""
Live WebSocket Distributed Component Telemetry Streamer for glycan-mass-spec-annotator.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "glycan-mass-spec-annotator", "event_type": event_type, "payload": data})
