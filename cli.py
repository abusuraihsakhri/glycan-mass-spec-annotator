"""
Command Line Interface for Glycan Mass Spec Annotator.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="glycan-mass-spec-annotator", description="Glycan Mass Spec Annotator")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  GLYCAN MASS SPEC ANNOTATOR")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Glycan Mass Spec Annotator Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Glycan Mass Spec Annotator API server on http://{args.host}:{args.port}")
