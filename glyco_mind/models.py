"""
Data Models & Telemetry Definitions for GlycoMind: N-Glycan & O-Glycan Tandem Mass Spectrometry Fragmenter Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "SNFG / GlycoCT Structural Representation"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
