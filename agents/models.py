"""
Pydantic v2 schemas and data definitions for Glycan Mass Spec Annotator.
...
class SystemTaskPayload(BaseModel):
    ...
    @classmethod
    def validate_identifiers_not_empty(cls, v: str) -> str:
...
class ConsensusDossier(BaseModel):
    dossier_id: str
    system_slug: str = "glycan-mass-spec-annotator"
