"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for glycan-mass-spec-annotator.
"""
import math
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Glycan Mass Spec Annotator"):
